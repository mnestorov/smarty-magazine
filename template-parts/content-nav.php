...
$tab1_title = get_post_meta(get_the_ID(), '_smarty_magazine_tab1_title', true) ?: __('Crypto Prices by Market Cap', 'smarty_magazine');
$tab1_content = get_post_meta(get_the_ID(), '_smarty_magazine_tab1_content', true) ?: '';
$tab2_title = get_post_meta(get_the_ID(), '_smarty_magazine_tab2_title', true) ?: __('Gainers & Losers', 'smarty_magazine');
$tab2_content = get_post_meta(get_the_ID(), '_smarty_magazine_tab2_content', true) ?: '';
$tab3_title = get_post_meta(get_the_ID(), '_smarty_magazine_tab3_title', true) ?: __('Stable Coins', 'smarty_magazine');

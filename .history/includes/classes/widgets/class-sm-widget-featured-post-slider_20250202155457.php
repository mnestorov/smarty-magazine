...
class __Smarty_Magazine_Featured_Post_Slider extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        if ($featured_posts->have_posts()) {
            ...
            // Navigation arrows
            echo '<div class="swiper-button-next transition5"><i class="fa fa-angle-right"></i></div>';
            echo '<div class="swiper-button-prev transition5"><i class="fa fa-angle-left"></i></div>';

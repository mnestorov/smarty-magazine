...
if (!function_exists('__smarty_magazine_customizer_styles')) {
	...
	function __smarty_magazine_customizer_styles() {
		...
		$news_ticker_tag_bg   = get_theme_mod('__smarty_magazine_news_ticker_tag_bg', '#212529');
		...
		$news_ticker_arrow    = get_theme_mod('__smarty_magazine_news_ticker_arrow', '#212529');
		...
		$rgba_primary = __smarty_magazine_hex2rgba($primary, 0.75);
		if ($rgba_primary) {
			$custom_css .= "
